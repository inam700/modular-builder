...
class ProjectDetail extends Component {
  ...
  cancelCompare() {
    this.setState({ iscompare: !this.state.iscompare, hide: true });
  ...
  render() {
    return (
      <div className="ml-5">
        ...
        <div className="row mr-5">
          {this.state.simdataGroup.map((Detail, i) => (
            <div className="col-3 mb-2 mt-5">
              <Card
                onClick={
                  this.state.iscompare ? () => this.showDetail(Detail) : ""
                }
              ...
              >
                <div className="simulationcard ">
                  <div
                    className="text-right mr-2 pb-2"
                  ...
                  >
                    <input
                      ...
                      onChange={() => this.getSimIdCompare(Detail.id)}
                      name="isGoing"
                      type="checkbox"
                    ></input>
                  </div>
        ...
        <div
          className="row mt-n3 ml-1"
          style={this.state.hide ? { visibility: "hidden" } : {}}
        >
          <Button
            className="profilebtns textuppercase mr-4"
            disabled={this.state.isdisabled}
            onClick={() => this.compareApply()}
          >
            Apply
          </Button>
          <Button
