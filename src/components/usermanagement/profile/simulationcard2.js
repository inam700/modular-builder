    ...
    return (
      <div>
        <div className="row mr-5 devscroller mb-2">
          {this.props.simdata.map((Detail, i) => (
            <div className="col-3 mb-3">
              <Card
                onClick={
                  this.state.isgrouped ? () => this.showDetail(Detail) : ""
                }
                style={{ width: "260px", height: "200px", cursor: "pointer" }}
                className="simulation carddesign mr-3"
              >
                <div className="simulationcard ">
                  {this.state.isgrouped ? null : (
                    <div className="text-right mr-2">
                      <input
                        disabled={
                          this.state.idDisable.length > 0 &&
                          this.state.idDisable.length == 2 &&
                          Detail.id !== this.state.idDisable[0] &&
                          Detail.id !== this.state.idDisable[1]
                            ? true
                            : false
                        }
                        onChange={
                          this.state.compareButtom
        ...
        <div className="row mt-3 ml-1">
          ...
          >
            <img src={Foldericon} alt="" className="mr-2 mt-n1"></img>group
          </Button>
          <Button
            onClick={() => {
              this.ComparePressed();
            }}
            className="profilebtns textuppercase"
            disabled={this.state.isenabled}
          >
        ...
        >
          ...
          <Modal.Body>
            <div className="row">
              ...
              <div className="col-4">
                <p style={{ color: "darkblue", textAlign: "center" }}>
                  Name your Project
                </p>
              </div>
              <div className="col-4"></div>
            ...
            <div className="row">
              ...
              <div className="col-6">
                <input
                  onChange={(item) => this.valid(item, "ProjectName")}
