    ...
    return (
      <div className="myfontfamily mycontainer">
        ...
        <div className="row mt-3 mb-3 mr-5 devscroller">
          {this.state.myConnectors.map((Detail, i) => (
            <div className="col-3 mb-3">
              <Card
                onClick={() => this.showDetailProject(Detail)}
                className="simulation carddesign"
                style={{ height: "190px", width: "260px", cursor: "pointer" }}
              >
        ...
        {/* <div className="row mt-3 ml-3">
          <div className="col-12 ">
            <Simulationcard2
              ...
              group={this.state.isgrouped}
              compare={this.state.compareButtom}
            ></Simulationcard2>
          </div>
        </div> */}
      </div>
